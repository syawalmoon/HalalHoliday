...
const PricingandcalendarRateplansPage = () => {
  ...
  return (
    <>
      <Column className="bg-gray_50 font-ptsans items-center justify-start mx-[auto] 3xl:pb-[108px] lg:pb-[64px] xl:pb-[80px] 2xl:pb-[90px] w-[100%]">
        <Column className="items-center justify-start w-[100%]">
          ...
          <Column className="font-roboto justify-start mt-[4px] w-[100%]">
            ...
            <Row className="font-ptsans items-center xl:ml-[105px] 2xl:ml-[119px] 3xl:ml-[142px] lg:ml-[84px] lg:mt-[32px] xl:mt-[40px] 2xl:mt-[45px] 3xl:mt-[54px] w-[41%]">
              <Stack
              ...
              <Button
                className="font-bold lg:ml-[12px] xl:ml-[15px] 2xl:ml-[17px] 3xl:ml-[20px] lg:text-[11px] xl:text-[14px] 2xl:text-[16px] 3xl:text-[19px] text-center w-[84%]"
                size="xl"
