...
const AddpropertyPage = () => {
  ...
  return (
    <>
              ...
              <Column className="justify-start lg:mb-[13px] xl:mb-[16px] 2xl:mb-[19px] 3xl:mb-[22px] w-[99%]">
                <Row className="items-end w-[100%]">
                  ...
                  <Img
                    ...
                    className="lg:h-[15px] xl:h-[15px] 2xl:h-[37px] 3xl:h-[44px] lg:mb-[5px] xl:mb-[7px] 2xl:mb-[8px] 3xl:mb-[9px] lg:ml-[398px] xl:ml-[550px] 2xl:ml-[560px] 3xl:ml-[672px] w-[3%]"
                    alt="close"
                  />
                </Row>
              ...
              <Column className="items-center justify-start xl:mt-[11px] 2xl:mt-[13px] 3xl:mt-[15px] lg:mt-[9px] w-[100%]">
                <Column className="items-center justify-start w-[100%]">
                  <Row className="items-end justify-between w-[91%]">
                    ...
                    <Img
                      src="images/img_close_36X33.svg"
                      className="common-pointer lg:h-[15px] xl:h-[15px] 2xl:h-[28px] 3xl:h-[33px] w-[5%]"
      ...
      <Footer2 className="absolute bg-indigo_900 2xl:mt-[104px] lg:mt-[73px] xl:mt-[92px] inset-x-[0]  bottom-[1] text-center py-[40px] w-[100%]" />
    </>
  );
};
